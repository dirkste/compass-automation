...
class ProjectPaths:
    ...
    def get_project_root(cls) -> Path:
        ...
        if cls._project_root is None:
            # This file is in utils/, so project root is two levels up
            cls._project_root = Path(__file__).parent.parent.resolve()
    ...
    def get_config_path(cls, filename: str = "config.json") -> Path:
        ...
        """
        return cls.get_project_root() / "config" / filename
